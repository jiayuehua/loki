...
#ifndef __GLIBCPP_INTERNAL_FLEX_TREE_H
#define __GLIBCPP_INTERNAL_FLEX_TREE_H
...
{ 
  ...
  template<typename _Key, typename _Val, typename _KeyOfValue, 
    ...
    class _Rb_flex_tree : protected _Rb_tree_base<_Val, _Alloc>
    {
	...
	: _Base(allocator_type()), _M_node_count(0), _M_key_compare()
      ...
      _Rb_flex_tree(const _Compare& __comp)
	: _Base(allocator_type()), _M_node_count(0), _M_key_compare(__comp) 
      { _M_empty_initialize(); }

      _Rb_flex_tree(const _Compare& __comp, const allocator_type& __a)
	: _Base(__a), _M_node_count(0), _M_key_compare(__comp) 
      { _M_empty_initialize(); }

      _Rb_flex_tree(const _Rb_flex_tree<_Key,_Val,_KeyOfValue,_Compare,_Alloc>& __x)
	...
	_M_node_count = __x._M_node_count;
      ...
      _Rb_flex_tree<_Key,_Val,_KeyOfValue,_Compare,_Alloc>&
      operator=(const _Rb_flex_tree<_Key,_Val,_KeyOfValue,_Compare,_Alloc>& __x);
    ...
    public:    
      ...
      void 
      swap(_Rb_flex_tree<_Key,_Val,_KeyOfValue,_Compare,_Alloc>& __t)
      {
  ...
  template< class CompareType >
      const_iterator
      find(const CompareType& __k) const
    {
      _Link_type __y = _M_header; // Last node which is not less than __k.
      _Link_type __x = _M_root(); // Current node.
  ...
  template< class CompareType >
      size_type
      count(const CompareType& __k) const
    {
  ...
  template< class CompareType >
      iterator
      lower_bound(const CompareType& __k)
    {
      _Link_type __y = _M_header; /* Last node which is not less than __k. */
      _Link_type __x = _M_root(); /* Current node. */
  ...
  template< class CompareType >
      const_iterator
      lower_bound(const CompareType& __k) const
    {
      _Link_type __y = _M_header; /* Last node which is not less than __k. */
      _Link_type __x = _M_root(); /* Current node. */
  ...
  template< class CompareType >
      iterator
      upper_bound(const CompareType& __k)
    {
  ...
  template< class CompareType >
      const_iterator
      upper_bound(const CompareType& __k) const
    {
      _Link_type __y = _M_header; /* Last node which is greater than __k. */
      _Link_type __x = _M_root(); /* Current node. */
  ...
  template< class CompareType >
      ...
      equal_range(const CompareType& __k)
    { return pair<iterator, iterator>(lower_bound(__k), upper_bound(__k)); }

  template< class CompareType >
      pair<const_iterator, const_iterator>
      equal_range(const CompareType& __k) const
  ...
  template<typename _Key, typename _Val, typename _KeyOfValue, 
    ...
    inline bool 
    operator==(const _Rb_flex_tree<_Key,_Val,_KeyOfValue,_Compare,_Alloc>& __x,
	       const _Rb_flex_tree<_Key,_Val,_KeyOfValue,_Compare,_Alloc>& __y)
    {
  ...
  template<typename _Key, typename _Val, typename _KeyOfValue, 
           typename _Compare, typename _Alloc>
    inline void 
    swap(_Rb_flex_tree<_Key,_Val,_KeyOfValue,_Compare,_Alloc>& __x,
	 _Rb_flex_tree<_Key,_Val,_KeyOfValue,_Compare,_Alloc>& __y)
    { __x.swap(__y); }
  ...
  template<typename _Key, typename _Val, typename _KeyOfValue, 
           typename _Compare, typename _Alloc>
    typename _Rb_flex_tree<_Key,_Val,_KeyOfValue,_Compare,_Alloc>::iterator
    _Rb_flex_tree<_Key,_Val,_KeyOfValue,_Compare,_Alloc>::
  ...
  template<typename _Key, typename _Val, typename _KeyOfValue, 
           typename _Compare, typename _Alloc>
    pair<typename _Rb_flex_tree<_Key,_Val,_KeyOfValue,_Compare,_Alloc>::iterator,
    bool>
    _Rb_flex_tree<_Key,_Val,_KeyOfValue,_Compare,_Alloc>::
  ...
  template<typename _Key, typename _Val, typename _KoV, 
    ...
    template<class _II>
      void 
      _Rb_flex_tree<_Key,_Val,_KoV,_Cmp,_Alloc>::
  ...
  template<typename _Key, typename _Val, typename _KeyOfValue, 
           typename _Compare, typename _Alloc>
    inline void 
    _Rb_flex_tree<_Key,_Val,_KeyOfValue,_Compare,_Alloc>::erase(iterator __position)
    {
      _Link_type __y = 
  ...
  template<typename _Key, typename _Val, typename _KoV,
           typename _Compare, typename _Alloc>
    typename _Rb_flex_tree<_Key, _Val, _KoV, _Compare, _Alloc>::_Link_type
    _Rb_flex_tree<_Key,_Val,_KoV,_Compare,_Alloc>::
    _M_copy(_Link_type __x, _Link_type __p)
    {
  ...
  template<typename _Key, typename _Val, typename _KeyOfValue, 
           typename _Compare, typename _Alloc>
    void 
    _Rb_flex_tree<_Key,_Val,_KeyOfValue,_Compare,_Alloc>::_M_erase(_Link_type __x)
    {
  ...
  template<typename _Key, typename _Val, typename _KeyOfValue, 
           typename _Compare, typename _Alloc>
    bool 
    _Rb_flex_tree<_Key,_Val,_KeyOfValue,_Compare,_Alloc>::__rb_verify() const
    {
